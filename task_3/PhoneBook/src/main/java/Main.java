...
/*
		...
		phoneBook.addUr("Opa Zigotha", "15", 5);

		// phoneBook.printAll();

		phoneBook.writeFzInFile("FzUser.csv");
		phoneBook.writeUrInFile("UrUser.csv");
*/

		phoneBook.readFzFromFile("FzUser.csv");
		phoneBook.readUrFromFile("UrUser.csv");
		phoneBook.printAll();
	}
}